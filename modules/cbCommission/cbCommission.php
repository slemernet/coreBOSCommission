...
class cbCommission extends CRMEntity {
	...
	var $table_name = 'vtiger_cbcommission';
	var $table_index= 'cbcommissionid';
	 ...
	 */
	var $customFieldTable = Array('vtiger_cbcommissioncf', 'cbcommissionid');
	// Uncomment the line below to support custom field columns on related lists
	// var $related_tables = Array('vtiger_cbcommissioncf'=>array('cbcommissionid','vtiger_cbcommission', 'cbcommissionid'));

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_cbcommission', 'vtiger_cbcommissioncf');
	...
	var $list_link_field = 'cbcommissionno';
	...
	var $popup_fields = Array('cbcommissionno');

	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
	var $sortby_fields = Array();

	// For Alphabetical search
	var $def_basicsearch_col = 'cbcommissionno';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'cbcommissionno';

	// Required Information for enabling Import feature
	var $required_fields = Array('cbcommissionno'=>1);

	// Callback function list during Importing
	var $special_functions = Array('set_import_assigned_user');

	var $default_order_by = 'cbcommissionno';
	...
	function vtlib_handler($modulename, $event_type) {
		if($event_type == 'module.postinstall') {
			...
			if ($modEmp) $modEmp->setRelatedList($modCom, 'cbCommission', Array('ADD'),'get_dependents_list');
			if ($modInvoice) $modInvoice->setRelatedList($modCom, 'cbCommission', Array('ADD'),'get_dependents_list');
			if ($modSO) $modSO->setRelatedList($modCom, 'cbCommission', Array('ADD'),'get_dependents_list');
